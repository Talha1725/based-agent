...
const Header = () => {
	...
	const handleLogout = async () => {
		...
		try {
			...
			// Wait for wallet to disconnect before proceeding
			await disconnect();
			...
			<div className="flex items-center">
				...
				<div className="flex justify-center items-center w-[70%]">
					...
					<nav
						...
						<div
							...
							<NavLink active={currentPage === ""} href="/">Home</NavLink>
							<NavLink active={currentPage === "launch"} href="/launch">Launch</NavLink>
							<NavLink active={currentPage === "leaderboard"} href="/leaderboard">Leaderboard</NavLink>
							<NavLink active={currentPage === "docs"} href="/docs">Docs</NavLink>
							<ExternalLink href="https://twitter.com">Twitter</ExternalLink>
							<ExternalLink href="https://t.me">Telegram</ExternalLink>
				...
				<div className="flex items-center justify-end gap-5 space-x-2 w-[15%]">
					...
					{false ? <div className='animate-spin'><LoaderCircle className='text-black' /></div> : true ? (
						<UserSettingsMenu handleLogout={handleLogout} account={account} onDisconnect={handleDisconnectWallet} />
					) : (
						<w3m-button />
					)}
